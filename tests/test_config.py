from application.config import BASE_DIR, DevelopmentConfig, TestingConfig
...
class TestConfig:
    def test_development(self):
        ...
        assert app_config["SQLALCHEMY_DATABASE_URI"] == "sqlite:///" + BASE_DIR.joinpath('application.db').as_posix()
